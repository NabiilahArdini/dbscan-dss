...
Refrensi warna diatas bisa kita gabungkan dengan data scotty_final dengan menggunakan fungsi `left_join()` sehingga pada data scotty_final akan terbentuk kolom baru yaitu col. 
...
Visualisasi diatas menampilkan 9 cluster yang diwakili tiap warna tanpa menampilkan noise. Daerah tempat cluster terbentuk merupakan daerah yang memiliki kondisi `nodrivers` cukup tinggi di hari jumat pada pukul 15 hingga 19. Jika diperhatikan cluster 1 (biru tua) merupakan cluster terbesar, hal ini terjadi karena kerapatan didaerah tersebut lebih rapat dibandingkan dengan daerah lain.
...
Dari hasil cluster diatas pemilik aplikasi dapat memfokuskan mitra driversnya pada cluster tersebut sehingga kejadian nodrivers bisa dikurangi
